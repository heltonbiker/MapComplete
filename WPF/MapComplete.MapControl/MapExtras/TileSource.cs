...
namespace Microsoft.Maps.MapExtras
{
	internal abstract class TileSource
	{
		...
		public abstract long FinestLodWidth
		{
			get;
		}

		public abstract long FinestLodHeight
		{
			get;
		}
		...
		public abstract int MinimumLevelOfDetail
		{
			get;
		}

		public abstract int MaximumLevelOfDetail
		{
			get;
		}

		public abstract TimeSpan? TileFadeInDuration
		{
			get;
			set;
		}

		//public abstract Rect? Clip
		//{
		//	get;
		//	set;
		//}

		//public abstract Matrix3D Transform
		//{
		//	get;
		//}
